      ...
      media: [
        {
          ...
          mobileWidth: 1137,
          mobileHeight: 1560,
          alt: 'A real terminal capture: snapshot-runner repo-status prints the snapshot id, the artifact paths, the security boundary and the manual review workflow.',
          placement: 'hero',
          kind: 'screenshot',
          caption: 'A real repo-status run on a disposable example repository — output shown verbatim.',
        },
        {
          src: '/projects/snapshot-runner/workflow-system-en.svg',
          width: 760,
          height: 880,
          mobileSrc: '/projects/snapshot-runner/workflow-system-en-mobile.svg',
          mobileWidth: 460,
          mobileHeight: 810,
          alt: 'System diagram: four stages — collect read-only evidence, publish deterministic snapshot, review bounded summary, read targeted evidence — above the private snapshot store, the trust boundary and the four layers.',
          placement: 'system',
          kind: 'diagram',
          caption: 'The evidence path, the private store and the boundary; as of September 2026.',
        },
      ],
    },
    {
      ...
      media: [
        {
          ...
          mobileWidth: 1137,
          mobileHeight: 1464,
          alt: 'A real terminal capture: two project-context runs produce byte-identical output (cmp), followed by the first sections of the rendered Project Context document.',
          placement: 'hero',
          kind: 'screenshot',
          caption: 'A real run against the public context-loader source at tag v1.3.0 — output shown verbatim.',
        },
        {
          src: '/projects/context-loader/workflow-system-en.svg',
          width: 760,
          height: 880,
          mobileSrc: '/projects/context-loader/workflow-system-en-mobile.svg',
          mobileWidth: 460,
          mobileHeight: 810,
          alt: 'System diagram: five pipeline stages from locating the Git root to statuses and hashes, the boundary of what never happens, the size budgets and the four layers.',
          placement: 'system',
          kind: 'diagram',
          caption: 'The context pipeline, its boundaries and budgets; as of September 2026.',
        },
      ],
    },
  ],
